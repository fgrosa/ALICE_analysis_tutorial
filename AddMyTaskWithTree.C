AliAnalysisTaskMyTaskWithTree* AddMyTask(TString name = "name")
{
    ...
    mgr->ConnectOutput(task,2,mgr->CreateContainer("MyOutputTree", TTree::Class(), AliAnalysisManager::kOutputContainer, fileName.Data()));
